...
document.getElementById("convert").addEventListener("click", async (e) => {
  ...
  document.getElementById("result").innerHTML =
    "<img src='loading-gif.gif' width='48' height='48' />";
  ...
  if (ok) {
    ...
    if (err) {
      if (err["OnCooldown"]) {
        document.getElementById("result").innerHTML =
          "This function is on cooldown, please return in an hour.";
